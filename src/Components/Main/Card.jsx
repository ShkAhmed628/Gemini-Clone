...
const Card = () => {
  return (
    <div className="flex flex-col sm:flex-row sm:gap-4  gap-2 py-0 items-center  justify-center sm:justify-start sm:px-25">
          ...
          <div className=" bg-[var(--bg-light)] rounded-2xl p-5  sm:w-52 sm:h-44 w-99 h-40 flex flex-col justify-between cursor-pointer hover:bg-[var(--hover-gray)] transition-colors duration-200">
